...
public class JavaPpcSsh {
    ...
    static  String destIp = "10.10.55.88";
    static  int port = 22;
    static  String user = "mpsp";
    static  String pasword = "mpsp4321";


    public static void main(String[] args) throws Exception {
        String commandFace =  " cd /usr/mpsp/netbank/bankpre-faceroute/script; ./restart.sh ";
        String commandCups =  " cd /usr/mpsp/netbank/cups.Front4-app1/bin; ./restart.sh ";
